...
parser.add_argument(
    ...
    type=str,
    default="./test_images",
    help="the images root dir. Contains: (blend, transmission)",
)
...
parser.add_argument(
    "--name", type=str, default="test", help="the name of experiment, where to save model"
)
...
# (Pdb) opts
# Namespace(data_root='./test_images',
#     model_dir='./model', save_dir='./results',
#     name='test', num_threads=1, batch_size=1, serial_batches=True, display_id=-1)
# (Pdb) device
# 'cuda'
...
for i, data in enumerate(pbar):
    ...
    if gt_available:
        ...
        T_gt = np.asarray(T_gt, np.float32) / 255.0
        real_Ts.append(T_gt)
